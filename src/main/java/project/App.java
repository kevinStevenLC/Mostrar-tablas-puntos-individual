...
public class App extends Application {
    ...
    public void start(@SuppressWarnings("exports") Stage stage) throws IOException {
        ...
        controller.reciveDrivers(GenerateFxmlTable("tableDriversPoints", "Drive Points"));
        controller.reciveConstructors(GenerateFxmlTable("tableConstructorsPoints", "Constructor Points"));
        stage.show();
    }
